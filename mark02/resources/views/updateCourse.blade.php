        ...
        <div class="row justify-content-md-center">
            ...
            @method('put')
                <div class="form-row">
                    ...
                    <input type="number" class="form-control" name="horas" value="{{$course->horas}}">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                    <label for="inputEmail4">Escolaridade</label>
                    <input type="text" class="form-control" name="escolaridade" value="{{$course->escolaridade}}">
                    </div>
                    <div class="form-group col-md-6">
                    <label for="inputPassword4">Série</label>
                    <input type="number" class="form-control" name="serie" value="{{$course->serie}}">
                    </div>
                </div>
